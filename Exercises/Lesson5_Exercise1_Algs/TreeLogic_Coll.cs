...
namespace Lesson5_Exercise1_Algs
{
    ...
    public class TreeLogic_Coll
    {

        TreeNode_Coll Root { get; set; } = null;
        ...
        public void AddItem(int value)
        {
            ...
            if(Root == null)
            {
                Root = new TreeNode_Coll { Value = value };
                return;
            }
            ...
            while (currentNode != null)
            {
                if (value > currentNode.Value)
                {
                    ...
                    {
                        currentNode.RightChild = new TreeNode_Coll { Value = value, Parent = currentNode };
                        return;
                    }
                }
                else
                {
                    ...
                    {
                        currentNode.LeftChild = new TreeNode_Coll { Value = value, Parent = currentNode };
                        return;
                    }
                }
        ...
        public TreeNode_Coll GetNodeByValue(int value)
        {
            if(Root == null)
            {
                return null;
        ...
        public TreeNode_Coll GetRoot()
        {
            return Root;
        }

        public void PrintTree(TreeNode_Coll root, string space = "")
        {
            if(root != null)
            {
