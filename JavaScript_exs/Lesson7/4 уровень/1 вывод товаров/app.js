...
function showCategory(category) {
    ...
    if (category == 'phones') {
        for (let index = 0; index < products.phones.length; index++) {
            productsStr += getProductMarkup(products.phones[index]);

        }
    } else if (category == 'tablets') {
        for (let index = 0; index < products.tablets.length; index++) {
            productsStr += getProductMarkup(products.tablets[index]);

        }
    } else if (category == 'tv') {
        for (let index = 0; index < products.tv.length; index++) {
            productsStr += getProductMarkup(products.tv[index]);

        }
    }

    divEl.insertAdjacentHTML('afterbegin', productsStr);
}
